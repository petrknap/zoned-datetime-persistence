...
abstract class TestCase {
    ...
    protected final static String LOCAL_DATETIME_FORMAT = "yyyy-MM-dd HH:mm";
    protected final static String ZONED_DATETIME = "2025-10-25 16:05 +02:00";
    protected final static String ZONED_DATETIME_FORMAT = "yyyy-MM-dd HH:mm XXX";
    protected final static int ZONED_DATETIME_OFFSET = 7200;

    protected final DateTimeFormatter localDateTimeFormatter = DateTimeFormatter.ofPattern(LOCAL_DATETIME_FORMAT);
