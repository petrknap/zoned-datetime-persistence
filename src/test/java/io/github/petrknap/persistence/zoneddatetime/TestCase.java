...
abstract class TestCase {
    ...
    protected final static String LOCAL_PATTERN = "yyyy-MM-dd HH:mm";
    protected final static String ZONED_DATETIME = "2025-10-25 16:05 +02:00";
    protected final static String ZONED_PATTERN = "yyyy-MM-dd HH:mm XXX";
    protected final static int OFFSET = 7200;

    protected final DateTimeFormatter localDateTimeFormatter = DateTimeFormatter.ofPattern(LOCAL_PATTERN);
    protected final LocalDateTime localDateTime = LocalDateTime.parse(LOCAL_DATETIME, localDateTimeFormatter);
    protected final DateTimeFormatter zonedDateTimeFormatter = DateTimeFormatter.ofPattern(ZONED_PATTERN);
