...
import io.github.petrknap.persistence.zoneddatetime.UtcWithLocalDateTime;
...
public class Note {
    ...
    private UtcWithLocalDateTime createdAt;
    @Column
    private String content;

    public Note(ZonedDateTime createdAt, String content) {
        this.createdAt = new UtcWithLocalDateTime(createdAt);
